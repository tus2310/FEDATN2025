      ...
      <div className="container pt-[80px] border-t-2 border-black mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <div>
            ...
            <p>
              Gọi mua:{" "}
              <span className="text-blue-600 font-semibold">1900 232 460</span>{" "}
              (8:00 - 21:30)
            </p>
            <p>
              Khiếu nại:{" "}
              <span className="text-blue-600 font-semibold">1800 1062</span>{" "}
              (8:00 - 21:30)
            </p>
            <p>
              Bảo hành:{" "}
              <span className="text-blue-600 font-semibold">1900 232 464</span>{" "}
              (8:00 - 21:00)
            </p>
          </div>
        ...
        <div className="mt-6 text-center text-gray-600">
          <p>
            © 2025 Công ty Cổ phần Thế Giới Di Động. GPKD: 0303217354 do Sở KH &
            ĐT TP.HCM cấp ngày 02/01/2007.
          </p>
          <p>
          ...
          <p>
            Email:{" "}
            <a href="mailto:cskh@thegioididong.com" className="text-blue-600">
